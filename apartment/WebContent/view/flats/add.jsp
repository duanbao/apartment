...
<div class="box">
	...
	<table class="form-table">
		<tr>
			...
			<td colspan="3" class="control">
				<input type="text" name="h_id" placeholder="房屋ID">
			</td>
		</tr>
		<tr>
			<td>地区</td>
	...
	<tr>
		...
		<tr>
			<td>房屋图片</td>
			<td colspan="3" class="control">
				<input type="file" name="h_img" placeholder="图片">
			</td>
		</tr>
		<tr>
			<td>完整地址信息</td>
		...
		<tr>
			<td>加入时间</td>
			<td colspan="3" class="control">
				<input date="text" name="h_addtime" placeholder="加入时间">
			</td>
		</tr>
		<tr>
			<td>结束时间</td>
			<td colspan="3" class="control">
				<input date="text" name="h_updateTime" placeholder="结束时间">
			</td>
		</tr>		
	</table>
	<div class="buttons">
